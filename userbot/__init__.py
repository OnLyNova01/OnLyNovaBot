...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/OnLyNova01/OnLyNovaBot.git")
...
async def send_alive_status():
    if BOTLOG_CHATID:
        message = (
            "**OnLyNova Bot is up and running!**\n\n"
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("I'm [OnLyNova](https://github.com/OnLyNova01/OnLyNovaBot) modules helper...\nplease make your own bot, don't use mine 😋")
            else:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@OnLyNova"):
                buttons = paginate_help(0, dugmeler, "helpme")
                result = builder.article(
                    "Please Use Only With .help Command",
                    text="{}\nTotal loaded modules: {}".format(
                        "OnLyNova modules helper.\n",
                        len(dugmeler),
                    ),
                    buttons=buttons,
                    link_preview=False,
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "GitHub Repo",
                                "https://github.com/OnLyNova01/OnLyNovaBot"),
                            custom.Button.url(
                                "Support",
                                "https://t.me/NewStoreNova")],
                    ],
                    link_preview=False,
                )
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                # https://telegra.ph/OnLyNova-05-15-2
