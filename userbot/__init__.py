...
# Default botlog
BOTLOG_MSG = os.environ.get("BOTLOG_MSG") or f"```💢 OnLyNovaBot DAH AKTIF KONTOL!!! 💢```"
...
# Blacklist User for use OnLyNova
while 0 < 6:
    _BLACKLIST = get(
        ""
    )
...
# Default .alive Name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "OnLyNova")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "OnLyNova")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/OnLyNova-05-15-2"

# Default .helpme logo
HELP_LOGO = os.environ.get(
   "HELP_LOGO") or "https://telegra.ph/OnLyNova-05-15-2"

# Default .alive Instagram
IG_ALIVE = os.environ.get("IG_ALIVE") or "instagram.com/fck.alll"
...
PLAY_PIC = (
    os.environ.get("PLAY_PIC") or "https://telegra.ph/OnLyNova-05-15-2"
)

QUEUE_PIC = (
    os.environ.get("QUEUE_PIC") or "https://telegra.ph/OnLyNova-05-15-2"
)


# Default .alive Group
GROUP_LINK = os.environ.get(
    "GROUP_LINK") or "t.me/NewStoreNova"

# Default .repo Bot
OWNER_BOT = os.environ.get(
    "OWNER_BOT") or "t.me/onlynova"

# CH sfs bot
CH_SFS = os.environ.get("CH_SFS") or "t.me/newstorenova"
...
#Import Userbot - Ported by OnLyNova
from userbot import (
    ALIVE_NAME
)
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**OnLyNova v{BOT_VER} Sedang berjalan!**\n\n"
    ...
    try:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@RamUserbot"):
                ...
                result = builder.photo(
                    file=ramlogo,
                    link_preview=False,
                    text=f"** OnLyNovaBot MENU **\n\n•  **Owner** [{user.first_name}](tg://user?id={user.id})\n•  **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository OnLyNovaBot",
                    url="https://t.me/Onlynova",
                    thumb=InputWebDocument(HELP_LOGO, 0, "image/jpeg", []),
                    text="** OnLyNovaBot **\n➖➖➖➖➖➖➖➖➖➖\n❍▸ **Owner Repo :** [merdhani](https://t.me/OnLyNova)\n**Support :** @UserbotCh\n❍▸ **Repository :** [⭐ OnLyNovaBot ⭐](https://t.me/OnLyNova)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/newstorenova"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://t.me/OnLyNova"
                            ),
                        ],
                    ],
                    link_preview=False,
                ...
                result = builder.article(
                    title=" OnLyNovaBot ",
                    description="OnLyNovaBot | Telethon",
                    url="https://t.me/OnLyNova",
                    thumb=InputWebDocument(HELP_LOGO, 0, "image/jpeg", []),
                    text=f"** OnLyNovaBot **\n➖➖➖➖➖➖➖➖➖➖\n**UserMode:** [{user.first_name}](tg://user?id={user.id})\n**Assistant:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**Support:** @NewStoreNova\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/OnLyNova"),
                            custom.Button.url(
                                "repo", "https://t.me/OnLyNova"
                             ),
                        ],
                    ],
                    link_preview=False,
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**⭐ OnLyNovaBot ⭐ Inline Menu**\n\n **Owner** [{user.first_name}](tg://user?id={user.id})\n•  **Jumlah** `{len(dugmeler)}` Module"
                await event.edit(
                    text,
                    file=ramlogo,
                    buttons=buttons,
                ...
                reply_pop_up_alert = f"Jangan Asal pencet aja kontol, Itu milik {owner}"
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                reply_pop_up_alert = (
                    f"Jangan asal pencet aja kontol, itu milik {ALIVE_NAME}"
                )
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
