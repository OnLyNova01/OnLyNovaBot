...
async def reedme(event):
    await event.edit(
        ...
        "\n[onlynovabot's README.md file](https://github.com/OnLyNova01/onlynovabot/blob/main/README.md)"
        ...
        "\n[Instant Setup - String Session](https://onlynovabot.keselekpermen.repl.run)")
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click here](https://github.com/OnLyNova01/onlynovabot) to open onlynovabot's repo."
    )
